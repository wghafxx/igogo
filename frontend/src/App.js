...
const Shell = () => {
  ...
  const openWithdrawalSupport = async () => {
    try {
            ...
            <div className="px-3 py-4 sm:px-4 sm:py-6">
              ...
              <footer className="pt-7 pb-2 text-center space-y-2">
                <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs">
                  ...
                  <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("open-rub-topup"))} className="text-[#999999] font-semibold hover:text-white transition-colors" data-testid="footer-tariffs-link">{t("footer.tariffs")}</button>
                  <button type="button" onClick={() => window.dispatchEvent(new CustomEvent("open-live-chat"))} className="text-[#999999] font-semibold hover:text-white transition-colors" data-testid="footer-support-button">{t("footer.support")}</button>
