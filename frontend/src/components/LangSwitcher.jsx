...
export default function LangSwitcher() {
  ...
  return (
    <div className="relative isolate grid h-11 w-[136px] shrink-0 grid-cols-2 rounded-full border border-white/[0.07] bg-[#13151b] p-[3px] shadow-[inset_0_1px_3px_#0003]" role="group" aria-label={lang === "ru" ? "Язык интерфейса" : "Interface language"} data-testid="lang-switcher">
