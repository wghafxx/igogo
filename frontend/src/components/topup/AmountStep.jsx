    ...
    <div data-testid="topup-amount-step">
      ...
      <div className="m-foot space-y-3">
        ...
        <div className="m-input m-input-sm" data-testid="promo-block">
          ...
          />
          <button onClick={applyPromo} disabled={busy || !code.trim()} className="m-iconbtn" data-active={active ? "true" : "false"} data-testid="promo-apply-button" title={t("common.apply")} aria-label={t("common.apply")}>
            <CheckIcon size={16} />
          </button>
        </div>
        {giftActive ? (
