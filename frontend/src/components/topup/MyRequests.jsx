...
export default function MyRequests({ items, onChanged, onNew }) {
  ...
  return (
    <div className="space-y-3" data-testid="my-requests">
      ...
      {items.length === 0 && <div className="m-box h-[160px] flex items-center justify-center text-[13px] text-white/50" data-testid="my-requests-empty">{t("requests.empty")}</div>}
