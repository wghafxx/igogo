...
export const REEL_START = { id: "case", name: "Finishline Case", type: "Case", rarity: "stock", image: `${IMG}/114958333422119.webp` };
export const REEL_FINAL = { id: "karambit", name: "Tiger Stripes", type: "Karambit", rarity: "special", image: `${IMG}/95211024718206.webp` };
export const REEL_FLY = [
  { id: "s1", image: `${IMG}/73060066712564.webp` },
  { id: "s2", image: `${IMG}/84048948308515.webp` },
  { id: "s3", image: `${IMG}/133957542310311.webp` },
];
