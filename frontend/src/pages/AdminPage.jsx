  ...
  return (
    <div className="blox-panel p-4 grid grid-cols-1 lg:grid-cols-[110px_1fr_320px] gap-4 items-start" data-testid="admin-deposit-row">
      ...
      <div className="space-y-2">
        ...
        {rap > 0 && rap < 60 && (
          <div className="text-[11px] text-[#ff8a8a] px-1" data-testid="admin-credit-preview">Меньше 60 RAP — зачислить нельзя, отклоните заявку</div>
        )}
        {rap >= 60 && (
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={busy || rap < 60 || rap > 1000000 || !allocationReady}
