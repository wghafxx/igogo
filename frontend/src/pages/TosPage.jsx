...
const RU = [
  ...
  ["3. Апгрейды и трейды", [
    ...
    "3.7. Принимаются скины от 60 RAP. Скины дешевле 60 RAP не зачисляются на баланс и не возвращаются — вы можете потерять такой скин. Будьте внимательны.",
...
const EN = [
  ...
  ["3. Upgrades and trades", [
    ...
    "3.7. Skins of 60 RAP and up are accepted. Cheaper skins are not credited and not returned — you may lose such a skin. Be careful.",
